        ...
        *,
        ...
        if context.attn_dp_size != 1:
            ...
            if (
                ...
                #     hidden_states_symm = torch.empty_like(hidden_states)
                # hidden_states_symm.copy_(hidden_states)
                # hidden_states_symm.symmetric_memory = True
                # hidden_states = hidden_states_symm
